                    ...
                    <ul className="sidebar-nav">
                        ...
                        <li className="sidebar-item active">
                            <Link to="/" className="sidebar-link">
                                <i className="fa fa-sliders align-middle" /> <span className="align-middle">Dashboard</span>
                            </Link>
                        </li>
                        ...
                        <li className="sidebar-item">
                            <div onClick={this.toggleMenu} data-toggle="collapse" className={`sidebar-link ${!this.state.menu ? 'collapsed' : ''}`} aria-expanded={this.state.menu} >
                                <i className="fa fa-th-large align-middle" aria-hidden="true" /> <span className="align-middle">Product</span>
                            </div>
                            <ul id="ui" className={`sidebar-dropdown list-unstyled ${this.state.menu ? 'collapsed show' : "collapse"} `} data-parent="#sidebar">
                                ...
                                <li className="sidebar-item"><Link className="sidebar-link" to="/product/category">Category</Link></li>
                                <li className="sidebar-item"><Link className="sidebar-link" to="/product/items">Item</Link></li>
